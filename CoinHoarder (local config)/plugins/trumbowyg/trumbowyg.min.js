        ...
        i.prototype = {
            ...
            buildEditor: function() {
                ...
                e.$ed.on("dblclick", "img", e.o.imgDblClickHandler).on("keydown", function(t) {
                    ...
                    var n = t.which;
                    n >= 37 && n <= 40 || (!t.ctrlKey && !t.metaKey || 89 !== n && 90 !== n ? i || 17 === n ? "undefined" == typeof t.which && e.semanticCode(!1, !1, !0) : (e.semanticCode(!1, "compositionend" === t.type && 13 === n), e.$c.trigger("tbwchange")) : e.$c.trigger("tbwchange"), setTimeout(function() {
                        i = !1
                    }, 200))
                }).on("mouseup keydown keyup", function(t) {
                    (!t.ctrlKey && !t.metaKey || t.altKey) && setTimeout(function() {
                        i = !1
                    }, 200), clearTimeout(r), r = setTimeout(function() {
